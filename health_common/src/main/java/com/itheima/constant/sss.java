...
public class sss {
    ...
    //SFEru-42dYFEvmHot4dz1UhsepDmOPDql0AfFt8p
    //aCzett8JLbldF42PhQGzw6ymQyWreY4Fu8drPKG3
    //szitheima78
    //http://q0vvdn7az.bkt.clouddn.com
    private static final String ACCESSKEY = "3DLwp3yMV0du0rNnJTkThT_u1FO7KslLyfpVXOR5";
    private static final String SECRETKEY = "EudeQP4HeAHoQf2DKFHmWx0b4sEpI0SKNUaUgvIS";
    private static final String BUCKET = "tangx";
    public static final String DOMAIN= "http://q0r2kx604.bkt.clouddn.com";

    //http://q0vvdn7az.bkt.clouddn.com/20190529083159.jpg
    public static void main(String[] args) {
        uploadFile("E:\\环境安装包\\5、资料\\78期就业班\\叶壁兴预习\\传智健康与Git\\Day04\\资源\\图片资源\\4.jpg","68c7c13f-8fc2-46c3-b5d6-f7ec7992dc6e1.jpg");
        //removeFiles("20190529083159.jpg");
    }
